module Constants
  ...
  HELP = <<TXT
    ...
    /random - переключиться в режим случайных вопросов (используется по умолчанию)
    /tours - переключиться в режим турниров
TXT
  ...
  CHOSEN_TOUR = 'Выбран турнир'
  TOUR_FINISHED = 'Турнир закончился. Чтобы выбрать новый - набери /tours. Для переключения в режим случайных вопросов - /random'
